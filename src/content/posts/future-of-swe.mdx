...
Calculators were invented, then came Wolfram Alpha, which can do a much better job than I ever could in arithmetic and differential equations.
I still studied and benefited significantly from calculus, because it gave me tools and various **abstractions** I can use to understand the world around me.
...
As I close this blog out, if there is one thing I want the current and future engineers who are reading this (and who hopefully will change the world in a much better way than I did/will) to remember, it is this:
...
In my opinion we are heading towards a future where those of us who apply the principles above will be able to make a significant, outsized impact that we were not able to before.
